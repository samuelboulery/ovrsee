...
import { Minus, Plus, PushPin } from '@phosphor-icons/react'
...
import { BandeCommandes } from './TerminalCommandes'
import { LAYOUT_ICONS, LAYOUT_IDS, SEG_ICONE, layoutLabel, panelStyle, type Layout } from './terminalLayout'
  ...
  return (
    <>
      ...
      >
        ...
        <BandeCommandes
          layout={layout}
          ouverte={bandeOuverte}
          onOuverte={setBandeOuverte}
          snapshot={snapshot}
          actions={actionsListe}
          erreurs={actionErrors}
          onActiver={activate}
          onOuvrirPreferences={onOpenPreferences}
          onRecharger={onReload}
          notice={notice}
          error={error}
          available={available}
        />
