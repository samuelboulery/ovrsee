    ...
    >
      ...
      <div style={s('max-width: 52ch;')}>
        <p style={s('margin: 0 0 8px; font-size: 13px; color: var(--color-neutral-500); line-height: 1.5;')}>
          ...
          <code style={s('font-family: var(--font-mono); color: var(--color-accent-ink);')}>
      ...
      <div style={s('max-width: 52ch;')}>
        ...
        <code
          style={s(
            'display: block; padding: 12px; background: var(--color-surface-card); border-radius: 4px; font-family: var(--font-mono); font-size: 11px; color: var(--color-accent-ink); word-break: break-all;',
          )}
        >
