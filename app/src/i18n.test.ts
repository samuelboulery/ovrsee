...
test('i18n: tous les dictionnaires ont les mêmes clés', () => {
  ...
  const keys: Array<string> = [
    ...
    'pref.title', 'pref.close', 'pref.group_settings', 'pref.group_project',
    'pref.general', 'pref.activity', 'pref.actions',
    'pref.startup', 'pref.advanced', 'pref.language', 'pref.language_fr',
